...
public final class ActivityStartBinding implements ViewBinding {
  ...
  private ActivityStartBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivityStartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStartBinding((ConstraintLayout) rootView, textView);
    }
